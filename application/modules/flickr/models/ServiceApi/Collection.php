...
class Flickr_Model_ServiceApi_Collection extends EPIC_Model_ServiceApi_Abstract 
{
    ...
    public function find($id)
    {
        ...
        $result = $this->getAdapter()->method('flickr.collections.getTree')
           ->collection_id($id)
           ->get();
        ...
        return array($result->collections->collection);
    }
}
